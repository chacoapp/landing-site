...
const ChacoConcept = () => {
  ...
  useEffect(() => {
    ...
    // Start fading out logo after 1 second
    const introTimer = setTimeout(() => {
      setIntroComplete(true);
    }, 1000);

    // Start fading in content after 1.5 seconds (added 0.5s delay)
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#070707] via-[#111111] to-[#070707] text-white overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className={`relative z-20 min-h-screen flex items-center px-4 sm:px-8 md:px-16 lg:px-24 hero-content ${contentVisible ? 'hero-content-fade-in' : ''}`}>
        <div className="absolute inset-0 bg-gradient-to-b from-[#65b461]/20 via-[#4b8848]/15 to-[#070707]"></div>
        ...
        <div className="flex flex-col items-center justify-center w-full max-w-4xl mx-auto text-center relative z-10">
          <div className="mb-8 sm:mb-12 w-36 sm:w-46 transform hover:scale-105 transition-transform duration-300">
            <img
              src="/assets/logo.png"
              alt="Chaco Logo"
          ...
          <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 sm:mb-8">
            <span className="block text-white">Progress is better</span>
            <span className="bg-[linear-gradient(120deg,#65b461,#7ec47b)] bg-clip-text text-transparent">together.</span>
          </h1>

          <p className="text-lg sm:text-xl md:text-2xl text-[#C5C6CC] mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center w-full px-4 sm:px-0">
            <a
              ...
              className="flex items-center justify-center gap-2 px-6 sm:px-8 py-3 bg-[#52a050] hover:bg-[#65b461] text-white rounded-lg transition-colors w-full sm:w-auto"
              target="_blank"
            ...
            <button
              className="flex items-center justify-center gap-2 px-6 sm:px-8 py-3 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-colors backdrop-blur-sm cursor-not-allowed w-full sm:w-auto"
            >
      ...
      <section className="py-16 sm:py-24 relative overflow-hidden bg-[#111111]">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
          <div className="text-center mb-12 sm:mb-20">
            <span className="inline-block py-2 px-4 rounded-full bg-[#52a050]/10 text-[#65b461] text-sm font-medium mb-4 sm:mb-5">Features</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-white">What makes Chaco different</h2>
            <p className="text-lg sm:text-xl text-[#C5C6CC] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {featuresData.map((feature, index) => (
              <div
                key={index}
                className="feature-card bg-[#1A1A1A] rounded-2xl p-6 sm:p-8 hover:bg-[#222222] transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl border border-white/5"
              >
                <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">{feature.icon}</div>
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-white">{feature.title}</h3>
                <p className="text-[#C5C6CC] text-sm sm:text-base">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 relative overflow-hidden bg-[#070707]">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
          <div className="text-center mb-12 sm:mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-white">See Chaco in Action</h2>
            <p className="text-lg sm:text-xl text-[#C5C6CC] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
            ...
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Track Your Habits</h3>
              <p className="text-[#C5C6CC] mb-6 sm:mb-8 text-sm sm:text-base">Set goals, track progress, and stay accountable with your friends. Watch your habits grow day by day.</p>
            ...
            {/* Post Panel Showcase */}
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Share Your Progress</h3>
              <p className="text-[#C5C6CC] mb-6 sm:mb-8 text-sm sm:text-base">Post updates, celebrate wins, and keep your friends in the loop. Make habit-building social and fun.</p>
              <div className="stacked-showcase">
                <div className="stacked-container">
                  <button
                    onClick={prevPost}
      ...
      <section className="py-16 sm:py-24 relative overflow-hidden bg-[#111111]">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
          <div className="text-center mb-12 sm:mb-20">
            <span className="inline-block py-2 px-4 rounded-full bg-[#52a050]/10 text-[#65b461] text-sm font-medium mb-4 sm:mb-5">Testimonials</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-white">Hear from our users</h2>
            <p className="text-lg sm:text-xl text-[#C5C6CC] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {testimonialsData.map((testimonial, index) => (
              <div
                key={index}
                className="bg-[#1A1A1A] rounded-2xl p-6 sm:p-8 hover:bg-[#222222] transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl border border-white/5"
              >
                <div className="flex items-center gap-4 mb-4 sm:mb-6">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#4b8848]/10 rounded-full flex items-center justify-center text-xl sm:text-2xl">
                    {testimonial.avatar}
                  </div>
                  <div>
                    <div className="text-white font-bold text-sm sm:text-base">{testimonial.name}</div>
                    <div className="text-[#C5C6CC] text-xs sm:text-sm">{testimonial.habit}</div>
                  </div>
                </div>
                <p className="text-[#C5C6CC] italic text-sm sm:text-base">"{testimonial.quote}"</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="pt-8 pb-2 relative overflow-hidden bg-[#070707]">
        <div className="absolute inset-0 bg-gradient-to-r from-[#4b8848]/15 to-[#65b461]/15 animate-gradient"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#4b8848]/15 via-transparent to-transparent" style={{ transform: 'translateY(-60%) scale(1.5)' }}></div>
        <div className="absolute top-0 left-0 right-0 h-96 bg-gradient-to-b from-[#070707] via-[#070707]/95 to-transparent"></div>

        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-white">Ready to build better habits?</h2>
          <p className="text-lg sm:text-xl text-[#C5C6CC] mb-8 sm:mb-12 max-w-2xl mx-auto">
          ...
          <div className="text-[#C5C6CC] mb-4 sm:mb-6">
            <p className="mb-2 text-sm sm:text-base">Questions? Contact us at:</p>
            <a href="mailto:chacobetatesting@gmail.com" className="text-[#65b461] hover:text-[#52a050] font-medium transition-colors text-sm sm:text-base">
      ...
      {/* Footer */}
      <footer className="bg-[#070707] text-white py-4 sm:py-6 border-t border-white/5">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[#C5C6CC] text-xs sm:text-sm">&copy; {new Date().getFullYear()} Chaco 🐢 Raised in Austin, TX</p>
        </div>
      </footer>
    </div>
  );
